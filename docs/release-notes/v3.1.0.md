...
This stable release promotes the measured v3.1 feature set. The normal Java programming model
is unchanged: handlers, services, components, and DTO contracts stay in Java. Rust continues to handle
HTTP I/O, native response paths, file streaming, overload control, and selected serialization-heavy
fast paths.
...
- UTF-8 handling is covered for response bodies, path variables, request params, cookies, middleware query helpers, and WebSocket params.
