...
| Full compatibility application | `sample/target/rust-java-rest-4.5.3-sample.jar` |
| Self-contained minimal benchmark classpath | `target/rust-java-rest-4.5.3-core-runtime.jar` |
| Build-only processors | `rust-java-rest-4.5.3-codegen.jar` |
