...
| Need | Artifact |
| --- | --- |
| Production dependency | `com.reactor:rust-java-rest:4.5.2` |
| Full compatibility application | `sample/target/rust-java-rest-4.5.2-sample.jar` |
| Self-contained minimal benchmark classpath | `target/rust-java-rest-4.5.2-core-runtime.jar` |
| Build-only processors | `rust-java-rest-4.5.2-codegen.jar` |
