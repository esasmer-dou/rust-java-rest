...
| Need | Artifact |
| --- | --- |
| Production dependency | `com.reactor:rust-java-rest:4.5.4` |
| Full compatibility application | `sample/target/rust-java-rest-4.5.4-sample.jar` |
| Self-contained minimal benchmark classpath | `target/rust-java-rest-4.5.4-core-runtime.jar` |
| Build-only processors | `rust-java-rest-4.5.4-codegen.jar` |
