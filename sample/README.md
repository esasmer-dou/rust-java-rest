...
| Need | Artifact |
| --- | --- |
| Production dependency | `com.reactor:rust-java-rest:4.4.0` |
| Full compatibility application | `sample/target/rust-java-rest-4.4.0-sample.jar` |
| Self-contained minimal benchmark classpath | `target/rust-java-rest-4.4.0-core-runtime.jar` |
| Build-only processors | `rust-java-rest-4.4.0-codegen.jar` |
