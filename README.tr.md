...
[![Sürüm](https://img.shields.io/badge/sürüm-4.5.3-blue.svg)](https://github.com/esasmer-dou/rust-java-rest/releases/tag/v4.5.3)
...
[![Durum](https://img.shields.io/badge/durum-stable-blue.svg)](https://github.com/esasmer-dou/rust-java-rest/releases/tag/v4.5.3)
...
- Windows ve Linux native dosyaları temiz `rust-spring v4.5.3` CI build'inden alınır.
...
- Native DLL/SO, `4.5.3` Maven artifact'i içinde gelen dosya olmalıdır.
...
`4.5.3` sürümü, uyumlu `java-rust-glowroot-agent:0.3.0` paketiyle kullanılabilir. Mikro ajan şu
...
Stable `4.5.3` runtime; sınırlı `micro`, `jvm`, `sql`, `full` ve `diagnostic` profillerini destekler.
...
ve `+1,754 MiB` oldu; telemetri thread'i eklenmedi. `4.5.3`, export ve profil kaynak bırakma işini
...
Uyumlu dependency çizgisi `rust-java-rest:4.5.3`, `java-rust-dubbo:0.7.2` ve
...
- [4.5.3 sürüm notları](docs/release-notes/v4.5.3.tr.md)
