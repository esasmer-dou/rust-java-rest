 ...
 * Identifies bottlenecks in Java-side processing
 *
 * Run: java -cp "target/classes:target/lib/*" com.reactor.rust.profiling.StandaloneProfiling
 */
public class StandaloneProfiling {
    ...
    static void testStringAllocation() {
        ...
        // Test 1b: String literal (interned)
    ...
    static void testByteBufferWrite() {
        ...
        System.out.printf("  Direct ByteBuffer:   %.2f ns%n", (end2 - start2) / (double) ITERATIONS);
        System.out.printf("  System.arraycopy:    %.2f ns%n", (end3 - start3) / (double) ITERATIONS);
        System.out.printf("  Data size: %d bytes%n%n", data.length);
    }

    // ========================
    // TEST 3: Param Parsing (Current Implementation)
    // ========================
    static void testParamParsing_Current() {
        System.out.println("=== TEST 3a: Param Parsing (Current - New HashMap) ===");
    ...
    // ========================
    // TEST 3b: Param Parsing (Optimized)
    // ========================
    ...
    // ========================
    // TEST 5: MethodHandle Invocation
    // ========================
    static void testMethodHandleInvocation() throws Throwable {
        ...
        System.out.printf("  Speedup:             %.1fx faster%n%n",
            ((end2 - start2) / (double) ITERATIONS) / ((end1 - start1) / (double) ITERATIONS));
    }
    ...
    // ========================
    // TEST 6: Concurrent HashMap Access
    // ========================
    ...
    static void testAllocationOverhead() {
        ...
        // Test 7b: byte[] with zeros (simulating reuse)
